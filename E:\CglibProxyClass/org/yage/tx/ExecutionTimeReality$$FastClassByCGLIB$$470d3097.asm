...
// access flags 0x1
public class org/yage/tx/ExecutionTimeReality$$FastClassByCGLIB$$470d3097 extends net/sf/cglib/reflect/FastClass {
  ...
  public getIndex(Ljava/lang/String;[Ljava/lang/Class;)I
    ...
    LOOKUPSWITCH
      ...
      default: L5
   L0
   FRAME FULL [org/yage/tx/ExecutionTimeReality$$FastClassByCGLIB$$470d3097 java/lang/String [Ljava/lang/Class;] [[Ljava/lang/Class; java/lang/String]
    LDC "sayHello"
    INVOKEVIRTUAL java/lang/Object.equals (Ljava/lang/Object;)Z
    IFEQ L6
    DUP
  ...
  public invoke(ILjava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object; throws java/lang/reflect/InvocationTargetException 
    ...
    ALOAD 2
    CHECKCAST org/yage/tx/ExecutionTimeReality
    ILOAD 1
   L0
    TABLESWITCH
      0: L2
      ...
      default: L7
   L2
   FRAME SAME1 org/yage/tx/ExecutionTimeReality
    ALOAD 3
    ICONST_0
    AALOAD
    CHECKCAST java/lang/String
    INVOKEVIRTUAL org/yage/tx/ExecutionTimeReality.sayHello (Ljava/lang/String;)V
    ACONST_NULL
    ARETURN
   L3
   FRAME SAME1 org/yage/tx/ExecutionTimeReality
    ...
    AALOAD
    CHECKCAST java/lang/String
    INVOKEVIRTUAL org/yage/tx/ExecutionTimeReality.dealTask (Ljava/lang/String;)V
    ACONST_NULL
    ARETURN
   L4
   FRAME SAME1 org/yage/tx/ExecutionTimeReality
    ...
    ICONST_0
    AALOAD
    INVOKEVIRTUAL org/yage/tx/ExecutionTimeReality.equals (Ljava/lang/Object;)Z
   ...
   L5
   FRAME SAME1 org/yage/tx/ExecutionTimeReality
    INVOKEVIRTUAL org/yage/tx/ExecutionTimeReality.toString ()Ljava/lang/String;
    ARETURN
   L6
   FRAME SAME1 org/yage/tx/ExecutionTimeReality
    INVOKEVIRTUAL org/yage/tx/ExecutionTimeReality.hashCode ()I
  ...
  public newInstance(I[Ljava/lang/Object;)Ljava/lang/Object; throws java/lang/reflect/InvocationTargetException 
    TRYCATCHBLOCK L0 L1 L1 java/lang/Throwable
   L2
    NEW org/yage/tx/ExecutionTimeReality
    DUP
    ILOAD 1
   L0
    TABLESWITCH
      ...
      default: L4
   L3
   FRAME FULL [org/yage/tx/ExecutionTimeReality$$FastClassByCGLIB$$470d3097 I [Ljava/lang/Object;] [L2 L2]
